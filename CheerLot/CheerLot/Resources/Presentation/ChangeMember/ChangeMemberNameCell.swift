        ...
        Button(action: action) {
            ZStack {
                RoundedRectangle(cornerRadius: DynamicLayout.dynamicValuebyHeight(8))
                    ...
                    .stroke(selected ? selectedTheme.primaryColor.opacity(0.7) : selectedTheme.buttonColor, lineWidth: selected ? DynamicLayout.dynamicValuebyWidth(1.5) : DynamicLayout.dynamicValuebyWidth(1))
